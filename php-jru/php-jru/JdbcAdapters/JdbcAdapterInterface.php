 ...
 */
 /**
 * Esta clase permite definir los metodos de un adaptador jdbc
 * */
interface JdbcAdapterInterface
{
	
	/**
	 * este metodo se ejecuta para obtener una conexion jdbc
	 *
	 * @param string host (ip o dns del servidor de base de datos)
	 * @param string puerto
	 * @param string nombre de la base de datos
	 * @param string ususario 
	 * @param string clave o password
	 * @return jbdc conexion 
	 * */
	public function getConexion($host,$port,$databse,$user,$password);	
}
?>
