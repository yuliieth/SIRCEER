...
#echo $numRows;
	...
	for ($i=2; $i <= $numRows; $i++) { 
		...
		$id_nivel = getAllSubjectByValue('nivel_academico','NO APLICA','nombre',$cn);
		#var_dump($id_nivel);
		$id_universidad = getAllSubjectByValue('universidades','NO APLICA','nombre',$cn);
		#var_dump($id_universidad);
		$id_jornada = getAllSubjectByValue('jornadas','NO APLICA','nombre',$cn);
		#var_dump($id_jornada);
...
(
	$snies,$nombre,$num_semestres,$valor_semestre,$id_nivel['id'],$id_universidad['id'],$id_jornada['id'],$cn
);
