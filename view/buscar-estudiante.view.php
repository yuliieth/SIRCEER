	...
	<tr class="row-primary">
		...
		<tr class="row-secundaria"<?php 
		 ...
		 ?>>
			...
			<td class="cell"> <a class="links-crud" href="<?php echo URL ?>gestion/gestionar-estudiante.php?id=<?php echo urlencode($filaAlumnos['documento'])?>&select=e">Gestionar</a></td>
			<td class="cell"> <a class="links-crud" href="<?php echo URL ?>gestion/editar-estudiante.php?id=<?php echo urlencode($filaAlumnos['documento'])?>&select=e">Editar</a></td>
...
>>>>>>> fdfbfa533ba3cb81e74dbdceee0689e08105ea2f
	</div>
</div>	
